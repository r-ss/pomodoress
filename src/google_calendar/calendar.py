...
class GoogleCalendar:
    ...
    def load_fake(self):
        ...
        cal_day_helper.add_event(CalendarEvent(f"{today}T15:00:00+02:00", f"{today}T16:00:00+02:00", "Test calendar event commute 2:00, back 2"))
        cal_day_helper.add_event(CalendarEvent(f"{today}T19:00:00+02:00", f"{today}T21:00:00+02:00", "Formula-1, focus"))
